...
const NewPasswordShelter = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    if(newPassword === confirmPassword){
      try{
        const setNewPass = await fetch("http://localhost:5000/reset-password-shelter",{
          method:"PATCH",
          headers:{
...
export default NewPasswordShelter;
