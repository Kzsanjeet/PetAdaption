...
const About=()=>{
    return (
        ...
        <section className="about-main-div">
            ...
            <h1>About us</h1>
            <p>Pet Adoption Website is Ireland and Northern Ireland’s largest animal adoption portal, bringing together dogs, cats, and other animals available to adopt from rescues across Ireland.
            ...
            <div className="faq-div">
                ...
                <p>Of course, go to www.petrescue.com to create your free PAW rescue manager account.</p>
                </article>
            </div>
